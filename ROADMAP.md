...
- Season record per team (D4, D6, D3): photo upload plus two typed final scores after each game, no OCR, no scoresheet parsing
- Ask DMBB directly whether they'll share a season data export for D4, D6 and D3, before considering any scraping of dmbb.ie
