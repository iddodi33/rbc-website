...
- [ ] Team and Roster, D4 and D7 shown as two separate rosters. Iddo, after shell is merged.
...
- DMBB league table for D4 and D7
...
- Season record per team (D4, D7): photo upload plus two typed final scores after each game, no OCR, no scoresheet parsing
- Ask DMBB directly whether they'll share a season data export for D4 and D7, before considering any scraping of dmbb.ie
